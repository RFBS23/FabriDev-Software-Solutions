...
const MultipleItems: React.FC = () => {
    const t = useTranslations('Articulos');
        ...
        <div className="bg-lightgrey py-20" id="blog-section">
            <div className="mx-auto max-w-7xl sm:py-4 lg:px-8">
                <div className="text-center">
                    ...
                    <h3 className="text-4xl sm:text-6xl font-bold">{t('subtitulo')}</h3>
                </div>
                <Slider {...settings}>
                    {postData.map((items, i) => (
                        <div key={i}>
                            <div className="bg-white m-3 px-3 pt-3 pb-12 my-10 shadow-lg rounded-3xl relative">
                                ...
                                <div>
                                    <h3 className="text-base font-normal pt-6 pb-2 opacity-75">{t(items.name)}</h3>
