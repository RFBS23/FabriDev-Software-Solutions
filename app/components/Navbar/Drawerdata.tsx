            ...
            <div className="flex-1 space-y-4 py-1">
                <div className="sm:block">
                    <div className="space-y-1 px-5 pt-2 pb-3">
                        ...
                        <button className="bg-navyblue w-full hover:text-white text-white border border-purple font-medium py-2 px-4 rounded"><a href="mailto:fabridevsoftwaresolutions@gmail.com?subject=¿Qué%20servicio%20necesitas?" id="enviaremail">{c('btncontact')}</a>
                        </button>
                        {/**/}<Contactusform/>
                        <h5>{t('switch')} &#x1F310;</h5>
                        <LocalSwitcher/>
